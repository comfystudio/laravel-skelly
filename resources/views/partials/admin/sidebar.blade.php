    ...
    <div class="bg-header-dark">
        <div class="content-header bg-white-10">
            ...
            <a class="link-fx font-w600 font-size-lg text-white" href="{{url('/')}}">
                <span class="text-white-75">{{SITE_NAME}}</span>
            </a>
            <!-- END Logo -->
    ...
    <div class="content-side content-side-full">
        <ul class="nav-main">
            <li class="nav-main-item">
                <a class="nav-main-link @if(isset($meta['section']) && $meta['section'] == 'Admin Users') active @endif" href="/admin/admin-users/">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link @if(isset($meta['section']) && $meta['section'] == 'Users') active @endif" href="/admin/users/">
                    <i class="nav-main-link-icon fa fa-users"></i>
                    <span class="nav-main-link-name">Frontend Users</span>
                </a>
            </li>

            <li class="nav-main-heading">News</li>
            <li class="nav-main-item @if(isset($meta['section']) && $meta['section'] == 'News') open @endif">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" @if(isset($meta['section']) && $meta['section'] == 'News') aria-expanded="true" @else aria-expanded="false" @endif>
                ...
                <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                        <a class="nav-main-link @if(isset($meta['subSection']) && $meta['subSection'] == 'News') active @endif" href="{{url('/admin/news/')}}">
                            <span class="nav-main-link-name">News</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link @if(isset($meta['subSection']) && $meta['subSection'] == 'Categories') active @endif" href="{{url('/admin/categories/')}}">
                            <span class="nav-main-link-name">Categories</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link @if(isset($meta['subSection']) && $meta['subSection'] == 'Tags') active @endif" href="{{url('/admin/tags/')}}">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link @if(isset($meta['section']) && $meta['section'] == 'Query') active @endif" href="/admin/queries/">
                    <i class="nav-main-link-icon fa fa-envelope"></i>
                    <span class="nav-main-link-name">Queries</span>
                </a>
            </li>
