                ...
                <div class="block-header block-header-default">
                    <div class="row w-100">
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-2">
                            <a href="/admin/categories/create" type="button" class="btn btn-success mb-1">
                                    ...
                                    @foreach($categories as $data)
                                        <tr @if($data->is_active == 0) class="alert alert-danger" @endif>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="/admin/categories/edit/{{$data->id}}/" type="button" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip" title="Edit User" data-original-title="Edit" aria-describedby="tooltip201328">
                                                        <i class="fa fa-pencil-alt"></i>
                                                    </a>
                                                    <a href="/admin/categories/delete/{{$data->id}}/" type="button" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip" title="Delete User" data-original-title="Delete">
