            ...
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/admin/tags/">@if(isset($meta['subSection'])) {{$meta['subSection']}} @endif</a></li>
                            <li class="breadcrumb-item active" aria-current="page">@if(isset($tags)) Edit @else Add @endif</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="block block-rounded block-bordered">
                <div class="block-header block-header-default">
                    <h3 class="block-title">@if(isset($meta['subSection'])) {{$meta['subSection']}} @endif @if(isset($tags)) Edit @else Add @endif</h3>
                </div>
                <div class="block-content">
                    <form action="/admin/tags/{{isset($tags) ? 'edit/'.$tags->id : 'create'}}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xl-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="name" name="name" class="form-control @if($errors->has('name')) is-invalid @endif" value="@if(old('name')){{old('name')}} @elseif(isset($tags->name)){{$tags->name}}@endif">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-8 ml-auto">
                                        <input type="submit" name="save" class="btn btn-info" value="@if(isset($tags)) Update @else Save @endif">
