                ...
                <div class="block-content">
                    ...
                    <div class="alert alert-danger alert-dismissable" role="alert">
                        ...
                        <h3 class="alert-heading font-size-h4 my-2">Warning</h3>
                            <li class="mb-2">Please note that this will remove this tag. You can add them again at a later time.</li>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xl-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-8 col-form-label" for="tagsname">You are removing: <strong>{{$tags['name']}}</strong></label>
                                </div>
