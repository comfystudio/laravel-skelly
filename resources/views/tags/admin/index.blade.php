            ...
            <div class="block block-rounded block-bordered">
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-md-3 col-lg-2 col-xl-2">
                            <div id="DataTables_Table_1_filter" class="dataTables_filter">
                                <label>
                                    <form class="form-wrap" method='get' action='/admin/tags/'>
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-2">
                            <a href="/admin/tags/create" type="button" class="btn btn-success mb-1">
                ...
                @if($tags->count())
                    <div class="block-content block-content-full">
                                    ...
                                    @foreach($tags as $data)
                                        <tr @if($data->is_active == 0) class="alert alert-danger" @endif>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="/admin/tags/edit/{{$data->id}}/" type="button" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip" title="Edit User" data-original-title="Edit" aria-describedby="tooltip201328">
                                                        <i class="fa fa-pencil-alt"></i>
                                                    </a>
                                                    <a href="/admin/tags/delete/{{$data->id}}/" type="button" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip" title="Delete User" data-original-title="Delete">
                        ...
                        {{$tags->links('partials/admin/admin')}}
                    </div>
                @else
                    <div class="block-content block-content-full">
                        <div class="col-xs-12">
