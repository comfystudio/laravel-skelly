                ...
                <div class="block-header block-header-default">
                    <div class="row w-100">
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-2">
                            <a href="/admin/admin-users/create" type="button" class="btn btn-success mb-1">
                                    ...
                                    @foreach($admin_users as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="/admin/admin-users/edit/{{$data->id}}/" type="button" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip" title="Edit Admin User" data-original-title="Edit" aria-describedby="tooltip201328">
                                                        <i class="fa fa-pencil-alt"></i>
                                                    </a>
                                                    @if(Session::get('AdminCurrentUserID') != $data->id)
                                                        <a href="/admin/admin-users/delete/{{$data->id}}/" type="button" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip" title="Delete Admin User" data-original-title="Delete">
